...
export function Purchase() {
    ...
    <div className="col">
        <div className="card card-default">
        <i className="fa-solid fa-cart-shopping card-img-top logo"></i>
        <div className="card-body">
...
export function Order() {
    ...
    <div className="col">
        <div className="card card-default">
        <i className="fa-solid fa-truck card-img-top logo"></i>
        <div className="card-body">
...
export function Inventory() {
    ...
    <div className="col">
        <div className="card card-default">
        <i className="fa-solid fa-boxes-stacked card-img-top logo"></i>
        <div className="card-body">
...
export function HR() {
    ...
    <div className="col">
        <div className="card card-default">
        <i className="fa-solid fa-people-group card-img-top logo"></i>
        <div className="card-body">
...
export function Finance() {
    ...
    <div className="col">
        <div className="card card-default">
        <i className="fa-solid fa-arrow-trend-up card-img-top logo"></i>
        <div className="card-body">
...
export function CRM() {
    ...
    <div className="col">
        <div className="card card-default">
        <i className="fa-regular fa-handshake card-img-top logo"></i>
        <div className="card-body">
